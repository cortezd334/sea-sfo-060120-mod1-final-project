...
l_monticello_r = WineList.create(wine_club_id: monticello.id, wine_club_id: monticello_red.id)
l_monticello_w = WineList.create(wine_club_id: monticello.id, wine_club_id: monticello_white.id)
l_monticello_g = WineList.create(wine_club_id: monticello.id, wine_club_id: generic_merlot.id)
l_chimney_rock_r = WineList.create(wine_club_id: chimney_rock.id, wine_club_id: chimney_rock_red.id)
l_chimney_rock_w = WineList.create(wine_club_id: chimney_rock.id, wine_club_id: chimney_rock_white.id)
l_chimney_rock_g = WineList.create(wine_club_id: chimney_rock.id, wine_club_id: generic_cabernet.id)
l_luna_r = WineList.create(wine_club_id: luna.id, wine_club_id: luna_red.id)
l_luna_w = WineList.create(wine_club_id: luna.id, wine_club_id: luna_white.id)
l_luna_g = WineList.create(wine_club_id: luna.id, wine_club_id: generic_noir.id)
l_beringer_r = WineList.create(wine_club_id: beringer.id, wine_club_id: beringer_red.id)
l_beringer_w = WineList.create(wine_club_id: beringer.id, wine_club_id: beringer_white.id)
l_beringer_g = WineList.create(wine_club_id: beringer.id, wine_club_id: generic_bordeaux.id)
